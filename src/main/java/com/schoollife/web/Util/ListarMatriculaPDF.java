...
public class ListarMatriculaPDF extends AbstractPdfView{
	...
	protected void buildPdfDocument(Map<String, Object> model, Document document, PdfWriter writer,
		...
		PdfPCell celda25 = new PdfPCell(new Phrase("País de nacimiento",fuenteTituloTabla));
		...
		celda25.setVerticalAlignment(PdfPCell.ALIGN_CENTER);
		...
		tablaReserva.setSpacingAfter(30);
			...
			PdfPCell celda32 = new PdfPCell(new Phrase(listaE.getEstablecimientoId().toString(),fuenteCeldas));
			celda24.setPadding(8);
			...
			PdfPCell celda34 = new PdfPCell(new Phrase(listaE.getPais_nacimiento(),fuenteCeldas));
			celda24.setPadding(8);
			tablaEvento.addCell(celda34);
			
			listaA.forEach(reserva->{
				PdfPCell celda36 = new PdfPCell(new Phrase(reserva.getNombres().toString() + " "+ reserva.getApaterno_apoderado(),fuenteCeldas));
				celda24.setPadding(30);
				tablaReserva.addCell(celda36);
				PdfPCell celda37 = new PdfPCell(new Phrase(reserva.getParentesco().toString(),fuenteCeldas));
				celda24.setPadding(30);
				tablaReserva.addCell(celda37);
				PdfPCell celda38 = new PdfPCell(new Phrase(reserva.getDomicilio_apoderado().toString(),fuenteCeldas));
				celda24.setPadding(30);
				tablaReserva.addCell(celda38);
				PdfPCell celda39 = new PdfPCell(new Phrase(formateadorFechaMedia.format(reserva.getFecha_nacimiento_apoderado()),fuenteCeldas));
				celda24.setPadding(30);
				tablaReserva.addCell(celda39);
			});
